%% load csv 
clear
t = readtable("/home/lapishla/Desktop/DD_audioFiles.csv", Delimiter=',');
...
% another option would 
 min_time = -3 * 60; % allow down to -5 minutes as this is the max file length.
...
%% Divide session time into thirds: DD %%
 min_time = -3 * 60; % allow down to -5 minutes as this is the max file length.
 max_time = 30 * 60; % Session should be max 60 minutes
 ecdf(post_issue(post_issue>min_time & post_issue<max_time))
 yline(0.333, '--')
 yline(0.666, '--')
